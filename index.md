...
*This documentation provides an overview of the Smart Control project to assist new developers in understanding and contributing to the codebase. For detailed API documentation, refer to the docstrings within the code and any auto-generated documentation.*
